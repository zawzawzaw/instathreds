            ...
            <div class="col-sm-12">
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-heading">
                  <h4 class="panel-title">ADD PROMO CODE</h4>
                </div>
                <div class="panel-body"> 
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input type="text" name="unique_promo_code" placeholder="Enter new promo code" class="form-control" />
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input type="text" name="usage_limit" placeholder="Enter usage limit" class="form-control" />
                      </div>
                    </div>                
