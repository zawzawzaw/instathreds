...
<html lang="en">
  <head>
    ...
    <title>Starter Style Guidelines</title>
        ...
        <section class="content">
          <div class="row">
            <div class="twelve column">
              ...
              <h1>Styleguide</h1>
              <p>This document is a guide to the mark-up styles used throughout the site. Parts of this markup guide are attributable to <a href="http://www.mezzoblue.com/">Dave Shea</a>, and licensed under a <a href="http://creativecommons.org/licenses/by-sa/2.0/uk/" rel="license">Creative Commons License</a>.</p>
              ...
              <div class="example">
                  <p><small>Copyright &copy; 1922-2011 Acme Corporation. All Rights Reserved.</small></p>
              </div>
              ...
              </p><h3>Superscript and subscript text</h3>
                  ...
                  <form action="#">
                      <fieldset>
                          ...
                          <div>
                              ...
                              <input type="url" class="text" id="url">
                              <em>Note about this field</em>
                          </div>
                          <div>
                          ...
                          <div>
                              ...
                              <input type="search" class="text" id="search">
                              <em>Note about this field</em>
                          </div>
                          <div>
                              <label for="textarea">Textarea</label>
                              <textarea cols="48" rows="8" id="textarea"></textarea>
                              <em class="clear">Note about this field</em>
                          </div>
                          <div>
                              <label for="checkbox">Single Checkbox</label>
                              <label class="check" for="checkbox"><input type="checkbox" class="checkbox" id="checkbox"> Label</label>
                          </div>
                          <div>
                          ...
                          <fieldset class="options">
                              ...
                              <ul>
                                  <li><label for="checkbox1"><input type="checkbox" checked="checked" name="checkbox" id="checkbox1"> Choice A</label></li>
                                  <li><label for="checkbox2"><input type="checkbox" name="checkbox" id="checkbox2"> Choice B</label></li>
                                  <li><label for="checkbox3"><input type="checkbox" name="checkbox" id="checkbox3"> Choice C</label></li>
                              </ul>
                          </fieldset>
                          <fieldset class="options">
                              <legend>Radio</legend>
                              <ul>
                                  <li><label for="radio1"><input type="radio" checked="checked" class="radio" name="radio" id="radio1"> Option 1</label></li>
                                  <li><label for="radio2"><input type="radio" class="radio" name="radio" id="radio2"> Option 2</label></li>
                              </ul>
                          </fieldset>
              ...
              <p>Here are the variations of buttons that you can use. Use any of the available button classes to quickly create a styled button.</p>
              ...
              <p></p><div class="notification message">
                  ...
                  <p><a href="http://www.justgiving.com/prlrun2012/" class="action">Sponsor my run on Just Giving ›</a></p>
              </div>
